...
See working code [source](https://glitch.com/edit/#!/deciduous-cooing-error?path=views%2Findex-aframe-1.0.4.html%3A14%3A9) and [live example](https://deciduous-cooing-error.glitch.me/)
